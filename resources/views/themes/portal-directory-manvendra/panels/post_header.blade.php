        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent ">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        @include('themes.portal-directory-manvendra.panels.navbar')
            ...
            <div class="bog-hero">
                ...
                <h1 class="text-uppercase">
                    <p class="text-capitalize">{{ $settings['title_above_content'] }}</p>
                    {{ !empty($post->title) ? $post->title : $post->slug }}
                    <br>
                    <span class="text-capitalize fs-5 text-reset">{{ $settings['title_bellow_content'] ?? ""
                        }}</span><br><br>
                </h1>
                <span class="resolver">
